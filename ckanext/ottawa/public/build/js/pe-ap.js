...
/*jshint bitwise: false */ (function($) {
  ...
  _pe = {
    ...
    suffix: $('body script[src*="/pe-ap-"]').attr('src').indexOf('-min') !== -1 ? '-min' : '',
    // determine if pe is minified
    header: $('#wb-head'),
    bodydiv: $('body > div'),
    main: $('#wb-main'),
    secnav: $('#wb-sec'),
    ...
    _init: function() {
      var $html = $('html'),
        hlinks, hlinks_same, $this, target, classes, test, init_on_mobileinit = false;
    ...
    array: {
      ...
      diff: function(arr1, arr2) {
        var i, _ilen, _iarr, j, _jlen, match, out = [];
    ...
    menu: {
      ...
      navcurrent: function(menusrc, bcsrc, navclass) {
        var pageurl = window.location.hostname + window.location.pathname,
          ...
          menulinks, menulink, menulinkurl, menulinkurllen, menulinkquery, menulinkquerylen, menulinkslen, bclinks, bclink, bclinkslen, bcindex, h1text = pe.main.find('h1').text(),
          match = false,
      ...
      buildmobile: function(menusrc, hlevel, theme_1, mbar, collapseTopOnly, theme_2, top, returnString, collapsible) {
        var heading = 'h' + hlevel,
          ...
          mItems_i, mItems_len, mItem, mItemDOM, mItemTag, next, nextDOM, hlink, hlinkDOM, navCurrent, nested, nested_i, nested_len, hnestDOM, hnestTag, hnestLinkDOM, hasHeading, menubar = (mbar !== undefined ? mbar : false),
          ...
          listItems, listItem, listItem2, sectionOpen = '<div data-theme="' + theme1 + '"' + ' class="wb-nested-menu',
    ...
    polyfills: {
      ...
      polyload: function(force, msg, checkdom) {
        var polyfills = this.polyfill,
          polyname, polyprefs, elms, polydep = {},
          loadnow = [],
          deps, dep_paths, dep_needed, lib = pe.add.liblocation,
          payload = [],
          needsinit = [],
          js = [],
          i, _len, $html = $('html');
      ...
      polyfill: {
        ...
        'mathml': {
          ...
          support_check: function() {
            ...
            var hasMathML = false,
              ns, divParent, div, divCompare, mrow, mo, mfrac;
    ...
    add: (function() {
      return {
        ...
        staged: [],
        // Tracks loaded dependencies and polyfills
        /**
        ...
        _load_arr: function(js, msg_all, payload) {
          var js_loaded = 0,
            i, _len, msg_single = msg_all + '-single';
    ...
    wb_load: function(options, finished_event) {
      ...
      var i, _len, settings = pe.settings,
        plugins = typeof options.plugins !== 'undefined' ? options.plugins : {},
        plug, pcalls = typeof options.global !== 'undefined' ? options.global : [],
        pcall, dep = typeof options.dep !== 'undefined' ? options.dep : [],
